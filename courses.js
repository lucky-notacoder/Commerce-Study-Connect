(function () {
  ...
  const renderChapterItem = (subjectId, chapter) => {
    ...
    return `
      <li>
        <a class="chapter-button" href="${getChapterUrl(subjectId, chapterName)}">
              ...
              <ol class="unit-list">
                ${units
                  .map(
                    (unit) => `
                      <li>
                        <a class="unit-button" href="${getChapterUrl(subjectId, unit)}">
                          ${escapeHtml(unit)}
                        </a>
                      </li>
                    `
